...
function App() {
  ...
  const [clubName, setClubName] = useState("");  
    ...
    useEffect(() => {
        fetch("https://student-backend-1-9zyu.onrender.com/")
            .then((res) => res.text())
            .then((data) => setMessage(data));
    }, []);

    const loadStudents = () => {
    fetch("https://student-backend-1-9zyu.onrender.com/all/students/")
        .then((res) => res.json())
...
useEffect(() => {
 ...
 const addStudent = (e) => {
    e.preventDefault();
    fetch("https://student-backend-1-9zyu.onrender.com/create/student", {
      method: "POST",
...
const verifyStudent = (studentEmail) => {
    fetch("https://student-backend-1-9zyu.onrender.com/update/isVerified", {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
...
const deleteStudent = (studentEmail) => {
    fetch("https://student-backend-1-9zyu.onrender.com/delete/student", {
        method: "DELETE",
        headers: { "Content-Type": "application/json" },
